...
#
#     Example: python mutate_model.py 6kak 231 CYS A > r231Aq.log
#
#
...
#first argument
modelname, respos, restyp, chain1, chain2, = sys.argv[1:]
...
#set up the mutate residue selection segment for chains
s = Selection(mdl1.chains[chain1].residues[respos],mdl1.chains[chain2].residues[respos])
#perform the mutate residue operation for chains
...
#only optimize the selected residues (in first pass, just atoms in selected
